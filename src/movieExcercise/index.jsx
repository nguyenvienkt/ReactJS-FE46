...
export default class MovieExcercise extends Component {

  renderMovies = () => {
    return data.map((movie, index) =>{
      //hàm map có 2 đối tượng và đối tượng thứ 2 có thể là index và ko trùng
      return (
        // Khi dùng hàm map thì phải có key định danh và gắn thẻ cha, to nhất
